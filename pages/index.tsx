  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB]">
      <main className="flex-1">
        <section className="relative overflow-hidden bg-gradient-to-b from-[#2766dd] via-[#154CB3] to-[#0f2f75] text-white">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-8 sm:pt-6 sm:pb-10">
            <motion.div
              ...
              className="rounded-3xl bg-white/25 border border-white/30 backdrop-blur-md px-5 sm:px-7 py-6 sm:py-8 shadow-[0_20px_60px_rgba(6,14,40,0.45)]"
            >
        ...
        <section className="bg-[#F4F6FB] pb-10 sm:pb-12 text-[#1f2f57]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8">
            <div className="text-center">
              ...
              <p className="text-xs sm:text-sm text-[#5b6a8a] mt-2">Simple, secure and streamlined</p>
            </div>

            <div className="mt-6 sm:mt-8">
              <div className="relative pl-10 sm:pl-14 space-y-4">
                <div className="absolute left-[1.125rem] sm:left-[1.625rem] top-3 bottom-3 w-0.5 bg-[#2b4fa8]/40" />
                {[
                  {
                    step: '1',
                  ...
                  <div key={item.step} className="relative flex items-center gap-4 sm:gap-5">
                    <div className="absolute -left-10 sm:-left-14 flex items-center justify-center">
                      <div className="w-9 h-9 rounded-full bg-[#2b4fa8] border-2 border-[#2b4fa8] text-white font-bold text-sm flex items-center justify-center shadow-sm">
                        {item.step}
                      </div>
                    </div>
