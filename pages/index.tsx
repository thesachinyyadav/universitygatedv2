    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col">
      <main className="flex-1">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-5 sm:pt-5 sm:pb-6">
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl min-h-[360px] sm:min-h-[420px] lg:min-h-[460px] p-5 sm:p-8 flex flex-col">
            <Image
            ...
            <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} className="relative z-10 max-w-3xl flex flex-col flex-1">
