              ...
              {formData.event_id && (() => {
                ...
                return selectedEvent ? (
                  <div className="mt-2 p-3 sm:p-4 bg-blue-50 rounded-lg text-xs sm:text-sm">
                    ...
                    <p className="text-blue-600 mt-2 inline-flex items-center gap-1.5">
                      <svg className="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                      </svg>
                      <span>{new Date(selectedEvent.date_from).toLocaleDateString()} - {new Date(selectedEvent.date_to).toLocaleDateString()}</span>
                    </p>
