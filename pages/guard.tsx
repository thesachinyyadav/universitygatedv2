...
export default function GuardDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      {/* Mobile Header */}
      <div className="bg-primary-800 text-white p-3 sticky top-0 z-30 shadow-md">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-[10px] text-primary-200">User: {user.username}</p>
          </div>
          <div className="flex gap-2">
            <button
              onClick={() => setActiveTab('scan')}
              className={`px-3 py-1 rounded-full text-[10px] font-semibold ${activeTab === 'scan' ? 'bg-white text-primary-800' : 'bg-primary-700 text-primary-200'}`}
            >
              Scanner
            </button>
            <button
              onClick={() => setActiveTab('history')}
              className={`px-3 py-1 rounded-full text-[10px] font-semibold ${activeTab === 'history' ? 'bg-white text-primary-800' : 'bg-primary-700 text-primary-200'}`}
            >
              History
            </button>
          </div>
      ...
      <div className="container mx-auto max-w-lg p-3 space-y-3">
